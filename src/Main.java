public class Main {
    public static void main(String[] args) {
        ...
        Event theater = new Event("Hamletr", 85.0);
        ...
        System.out.println("\nReservations for customer"+concertRef.getPrice()+ " to 150.0");
        ...
        System.out.println("\nReservation for customer " + customer1.getFirstName()+ " cancels theater reservation:");
